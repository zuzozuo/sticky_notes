...
class Note {
	constructor(x, y, z, width, height, text, uid) {
		...
		this.text = text;
		this.uid = uid;
	} //konstruktor karteczki


	create(func) { //funkcja przesylajaca zmienione dane na serwer
	...
	update(mode, value) { //funkcja aktualizujaca dane karteczki
		switch (mode) {
			case noteHeight:
				this.height = value;
				break;
	...
	tempFunc(parameters) { //pomocnicza funkcja, wpisujaca dane do wysylanego obiektu, w zaleznoci od parametrow
		let obj = {};
